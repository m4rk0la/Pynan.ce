...
def calculo_equilibrio_financeiro():
    ...
    try:
        percentual_gastos_essenciais = total_gastos_essenciais / total *100
        percentual_gastos_nao_essenciais = total_gastos_nao_essenciais / total *100
